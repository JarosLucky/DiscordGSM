...
const inviteLink = require('child_process').execSync(`${(heroku ? 'python3 ' : '')}${path.join(__dirname, '/../getbotinvitelink.py')}`, { encoding : 'utf-8' }) // Get bot invite link by getbotinvitelink.py
